...
class TestConfig {
    ...
    private static final String STORAGE_URL = "http://localhost:8080";
    private static final String SIGNAL_CDSI_URL = "http://localhost:8080";
    private static final String SIGNAL_SVR2_URL = "http://localhost:8080";
    private static final String CDN_URL = "http://localhost:8080";
    private static final String CDN2_URL = "http://localhost:8080";
    private static final String CDN3_URL = "http://localhost:8080";
