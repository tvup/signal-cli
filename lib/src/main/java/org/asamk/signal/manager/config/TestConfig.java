...
import static org.asamk.signal.manager.api.ServiceEnvironment.TEST;
...
class TestConfig {
    ...
    private static final String URL = "http://192.168.1.101:8081";
    private static final String STORAGE_URL = "http://192.168.1.101:8081";
    private static final String SIGNAL_CDSI_URL = "http://192.168.1.101:8081";
    private static final String SIGNAL_SVR2_URL = "http://192.168.1.101:8081";
    private static final String CDN_URL = "http://192.168.1.101:8081";
    private static final String CDN2_URL = "http://192.168.1.101:8081";
    private static final String CDN3_URL = "http://192.168.1.101:8081";
    ...
    static ServiceEnvironmentConfig getServiceEnvironmentConfig(List<Interceptor> interceptors) {
        return new ServiceEnvironmentConfig(TEST,
                LIBSIGNAL_NET_ENV,
